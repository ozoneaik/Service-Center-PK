                    ...
                    <tr>
                        <td style="vertical-align: top;">
                            <div class="product-info-container">
                                ...
                                <div class="product-description">
                                    <br/>
                                    รหัสสินค้า : {{ $job['pid'] }} | ซีเรียล : {{ $job['serial_id'] }} 
                                    <br/>
                                    Job ID : {{ $job['job_id'] }}
                                    <br/>
                                    ประเภท : {{ $job['p_cat_name'] }} | ประเภทย่อย : {{ $job['p_sub_cat_name'] }}
                        ...
                        <td style="width: 180px; text-align: right; vertical-align: top;">
                            <div class="barcode-container" style="display: inline-block; text-align: center;">
                                <img src="https://barcode.tec-it.com/barcode.ashx?data={{ $job['job_id'] }}&code=Code128&hidehrt=1"
                                    style="max-height: 40px; max-width: 100px;" alt="Job Barcode">
                                <!-- <div style="font-size: 11px; font-weight: bold; color: #000; margin-top: 3px;">
                                    {{ $job['job_id'] }}
                                </div> -->
                            </div>
                        </td>
