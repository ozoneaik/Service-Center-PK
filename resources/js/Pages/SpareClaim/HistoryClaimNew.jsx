            ...
            <Table>
                <TableHead sx={TABLE_HEADER_STYLE}>
                    <TableRow>
                        ...
                        {userRole !== 'acc' && <TableCell>สถานะเคลมอะไหล่</TableCell>}
                                ...
                                {canReceive && (
                                    <TableCell align="center">
                                        ...
                                        >
                                            ...
                                            {isAcc || isReceived ? 'ดูข้อมูล' : 'รับอะไหล่'}
                                        </Button>
                                    </TableCell>
                                )}
                            </TableRow>
                    ...
                    <Paper elevation={0} sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 2, display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap' }}>
                        ...
                        <Box sx={{ minWidth: '350px' }}>
                            <TextField
                                ...
                                onKeyDown={(e) => e.key === 'Enter' && handleSearchSubmit()} // กด Enter เพื่อค้นหา
                                slotProps={{
                                    input: {
                                        endAdornment: (
                            ...
                            >
                                <Box sx={{ p: 2, maxWidth: 300 }}>
                                    ...
                                    <Typography variant="body2" color="text.secondary">
                                        ...
                                        - <b>สถานะเซลล์รับอะไหล่:</b> สถานะเซลล์รับคืนอะไหล่จะไม่เกี่ยวข้องกับสถานะบัญชีรับอะไหล่ เมื่อเซลล์รับอะไหล่แล้ว หากกรอกรับจำนวนอะไหล่ครบสถานะจะเป็น complete ทันที <br />
                                        - <b>สถานะตรวจสอบบัญชี:</b> เมื่อเกิดเอกสาร RT สถานะเริ่มต้นจะเป็น Active หากรับคืนตรวจสอบและกรอกรับจำนวนอะไหล่ครบสถานะจะเป็น complete ทันที<br />
                                    </Typography>
                                </Box>
                            </Popover>
                        </Box>
