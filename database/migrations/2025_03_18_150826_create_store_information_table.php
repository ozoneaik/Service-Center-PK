...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('store_information', function (Blueprint $table) {
            ...
            $table->string('sale_id')->nullable()->comment('รหัสเซลล์ lark id');
            $table->tinyInteger('digit_code')->unique()->nullable()->comment('รหัสตัวเลข 4 หลักสำหรับร้านค้า');
            $table->string('line_id')->nullable()->comment('Line ID ของร้านค้า');
            $table->timestamps();
        });
    }
