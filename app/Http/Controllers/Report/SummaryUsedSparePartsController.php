...
class SummaryUsedSparePartsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $spareParts = $query
            ...
            ->through(function ($sp) use ($jobCounts, $withdrawCounts) {
                ...
                return [
                    ...
                    'detail_url' => route('report.summary-spare-parts.detail', [
                        'sp_code' => $sp->sp_code,
        ...
        return Inertia::render('Reports/SummaryUsedSpReport/SumUsedSpListMain', [
            'shops'          => $shops,
    ...
    public function exportExcel(Request $request)
    {
        ...
        $sheet->setCellValue('D1', 'งานซ่อม (process)');
        $sheet->setCellValue('E1', 'งานซ่อม (complete)');
        $sheet->setCellValue('F1', 'งานเบิก (process)');
        $sheet->setCellValue('G1', 'งานเบิก (complete)');
